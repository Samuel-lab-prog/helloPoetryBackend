...
responsibilities, constraints, and interaction with the rest of the architecture.
...
adapters → infra → external systems
use-cases → ports
infra → ports
...
When unsure:
> If the code knows *how data is stored or retrieved*, it belongs in infra.
